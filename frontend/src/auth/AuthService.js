...
export default class AuthService {
    ...
    auth0 = new auth0.WebAuth({
        domain: 'drowns-django-vue-js.auth0.com',
        clientID: '2zeD9BsH1Za3KYYdTTWNS3OskPlzlB6u',
    ...
    // sotres the user's access_token, id_token, and a time at
    ...
    // remote the access and ID tokens from the
